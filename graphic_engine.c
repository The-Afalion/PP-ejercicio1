/**
 * @brief Implementa un motor gráfico textual
 *
...
Graphic_engine *graphic_engine_create() {
    ...
    ge->banner = screen_area_init((int) ((WIDTH_MAP + WIDTH_DES + 1 - WIDTH_BAN) / 2), HEIGHT_MAP + 2, WIDTH_BAN,
                                  HEIGHT_BAN);
...
void graphic_engine_paint_game(Graphic_engine *ge, Game *game) {
    ...
    if ((obj_loc = game_get_object_location(game)) != NO_ID) {
        ...
        sprintf(str, "  Object location: none"); /* Si lo tiene el jugador, ya no está en el mapa */
    }
    screen_area_puts(ge->descript, str);

    /* . Mostrar el inventario del jugador (Si lleva el objeto o no) */
    ...
    screen_area_puts(ge->help, str);
    sprintf(str, "     take or t, drop or d");
    screen_area_puts(ge->help, str);

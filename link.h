...
/**
 * @brief Convierte una dirección enumerada a texto legible
 * @author Rodrigo
 * @param direction es Dirección a convertir
 * @return Cadena constante con el nombre de la dirección
 */
const char *link_direction_to_string(Directions direction);

...
OBJS = command.o game_actions.o game_loop.o game_reader.o game.o graphic_engine.o object.o player.o space.o set.o
...
game_actions.o: game_actions.c game_actions.h command.h types.h game.h space.h player.h object.h set.h
...
game.o: game.c game.h command.h types.h space.h player.h object.h game_reader.h set.h
	$(CC) $(CFLAGS) -c game.c
